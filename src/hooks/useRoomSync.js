...
const phaseToPath = (phase) => {
  switch (phase) {
    ...
    case 'logoquiz_lobby':        return '/logoquiz-lobby'
    case 'logoquiz_countdown':    return '/game/logoquiz'
    case 'logoquiz_question':     return '/game/logoquiz'
    case 'logoquiz_reveal':       return '/game/logoquiz'
    case 'logoquiz_final':        return '/game/logoquiz'
    ...
    case 'briscola_playing':  return '/game/briscola'
    case 'scopa_playing':     return '/game/scopa'
    case 'hub':        return '/hub'
