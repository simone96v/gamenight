// BlobDashLeaderboard — overlay fullscreen della classifica globale Blob Dash.
// Clone parametrico di BlobJumpLeaderboard: stesso layout/animazioni, label "Blob Dash".
...
import { useBlobDashLeaderboard } from '../useBlobDashLeaderboard'
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        <MiniBlob color={color || '#9CA3AF'} expr={isMe ? expr : 'normal'} size={28} id={`bd-lb-${rank}-${name}`} />
      </div>
      <span style={{
        fontWeight: 700,
...
const BlobDashLeaderboard = ({ open, onClose }) => {
  const C = usePlayerAccent()
  const expr = useMiniExpr()
  const { top, me, deviceId, loading, refresh } = useBlobDashLeaderboard({ enabled: open })
            ...
            <div style={{
              ...
              <div>
                ...
                <p style={{
                  ...
                  Blob Dash · best score per giocatore
                </p>
              </div>
...
export default BlobDashLeaderboard
