...
export const GAMES = [
  ...
  placeholder('cucu', 'cards', {
    name: 'Cucù',
    emoji: '🐦',
    tagline: 'Scambia o tieni',
    description: 'Carta in mano: la tieni o la scambi col vicino? Chi resta con la più bassa perde una vita. Eliminazione fino all\'ultimo blob in piedi.',
    difficulty: 1,
    minPlayers: 3,
    maxPlayers: 10,
    compatibility: { multi: true, single: false, excludedCategories: [] },
