...
export const GAMES = [
  ...
  // Classici italiani con mazzo da 40
  {
    ...
    name: 'Sette e Mezzo',
    emoji: '7️⃣',
    image: { light: '/games/cards/setteemezzo-light.png', dark: '/games/cards/setteemezzo-dark.png' },
  ...
  },
  {
    ...
    name: 'Briscola',
    emoji: '🃏',
    image: { light: '/games/cards/briscola-light.png', dark: '/games/cards/briscola-dark.png' },
    tagline: 'Il classico trick-taking',
    description: 'Mazzo da 40. Un seme è briscola e comanda su tutti. Solo vs CPU o online 1v1. Vince chi supera 60 punti.',
    difficulty: 2,
    minPlayers: 1,
    maxPlayers: 2,
    locked: false,
  ...
  },
  {
    ...
    name: 'Scopa',
    emoji: '🧹',
    image: { light: '/games/cards/scopa-light.png', dark: '/games/cards/scopa-dark.png' },
    tagline: 'Prendi il banco, fai scopa',
    description: 'Mazzo da 40. Prendi carte dal banco con somme uguali. Punti per Carte, Denari, Settebello, Primiera + Scope.',
    difficulty: 3,
    minPlayers: 1,
    maxPlayers: 1,
    locked: false,
    bg: 'linear-gradient(145deg, #A7F3D0 0%, #15803D 55%, #052E16 100%)',
    shadow: 'rgba(21, 128, 61, 0.40)',
    compatibility: { multi: false, single: true, excludedCategories: [] },
    component: lazy(() => import('../games/Scopa')),
  },
  {
    id: 'rubamazzetto',
    gameCategory: 'cards',
    name: 'Rubamazzetto',
    emoji: '🦹',
    image: { light: '/games/cards/rubamazzetto-light.png', dark: '/games/cards/rubamazzetto-dark.png' },
  ...
  },
  {
    ...
    name: 'Cucù',
    emoji: '🐦',
    image: { light: '/games/cards/cucu-light.png', dark: '/games/cards/cucu-dark.png' },
