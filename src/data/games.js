...
export const GAMES = [
  ...
  }),
  {
    ...
    description: 'Gioca una carta. Stessa carta del mazzetto avversario? Glielo rubi. Stesso valore sul tavolo? Lo prendi. Mazzo più alto vince.',
    difficulty: 1,
    minPlayers: 1,
    maxPlayers: 1,
    locked: false,
    bg: 'linear-gradient(145deg, #FBBF24 0%, #B45309 55%, #7C2D12 100%)',
    shadow: 'rgba(180, 83, 9, 0.40)',
    compatibility: { multi: false, single: true, excludedCategories: [] },
    component: lazy(() => import('../games/Rubamazzetto')),
  },
  {
    id: 'cucu',
    gameCategory: 'cards',
